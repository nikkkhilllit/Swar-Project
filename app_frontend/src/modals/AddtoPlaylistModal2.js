...
const AddToPlaylistModal2 = ({closeModal, addSongToPlaylist}) => {
    ...
    return (
        <div
            className="absolute bg-black w-2/3 h-2/3 bg-opacity-50 flex justify-center items-center"
            onClick={closeModal}
        >
            <div
                className="bg-app-black w-1/3 rounded-md "
                onClick={(e) => {
                    e.stopPropagation();
                }}
            >
...
export default AddToPlaylistModal2;
